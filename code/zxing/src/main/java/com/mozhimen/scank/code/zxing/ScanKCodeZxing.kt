package com.mozhimen.scank.code.zxing
 ...
 * @Version 1.0
 */
object ScanKCodeZxing : BaseUtilK() {
    ...
    fun createQRCodeBitmap(
        ...
        margin: String = "2",
        @ColorInt colorBg: Int = UtilKRes.gainColor(android.R.color.white),
        @ColorInt colorCode: Int = UtilKRes.gainColor(android.R.color.black)
    ): Bitmap? {
