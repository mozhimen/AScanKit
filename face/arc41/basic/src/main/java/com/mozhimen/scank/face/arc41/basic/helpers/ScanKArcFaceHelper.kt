...
import com.mozhimen.scank.face.arc41.basic.helpers.ScanKArcFaceUtil.keepMaxFace
        ...
        return if (_detectListener != null) {
            if (_faceTraceEngine != null) {
                ...
                if (code != ErrorInfo.MOK) {
                    ...
                    Log.v(TAG, "onPreviewFrame: detectFaces costTime = ${System.currentTimeMillis() - lastTime}ms")
                }
                //若需要多人脸搜索，删除此行代码
