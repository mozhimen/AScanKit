package com.mozhimen.scank.face.arc41.test.util.camera;
...
/**
 * 打开两个相机的辅助类，和{@link com.mozhimen.scank.face.arc41.test.util.camera.CameraListener}共同使用，获取nv21数据等操作
 * <p>
