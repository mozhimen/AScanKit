...
import com.mozhimen.scank.face.arc42.test.ui.viewmodel.ActiveViewModel;
import com.mozhimen.scank.face.arc42.test.R;
import com.mozhimen.scank.face.arc42.test.databinding.ActivityActivationBinding;
...
public class ActivationActivity extends BaseActivity {
    ...
    private void initViewModel() {
        activeViewModel = new ViewModelProvider(getViewModelStore(), (ViewModelProvider.Factory) new ViewModelProvider.AndroidViewModelFactory(getApplication())).get(ActiveViewModel.class);
