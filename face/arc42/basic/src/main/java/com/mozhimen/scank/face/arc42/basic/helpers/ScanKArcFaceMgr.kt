...
import com.mozhimen.scank.face.arc.basic.mos.*
import com.mozhimen.scank.face.arc42.basic.commons.IDetectListener
import com.mozhimen.scank.face.arc42.basic.cons.ScanKArcFaceConfig
import com.mozhimen.scank.face.arc42.basic.mos.FacePreviewInfo
import com.mozhimen.scank.face.arc42.basic.mos.LivenessResult
...
class ScanKArcFaceMgr : com.mozhimen.scank.face.arc.basic.commons.IScanKArcFace<DetectConfig, com.mozhimen.scank.face.arc.basic.commons.BinocularDetectCallback> {
    ...
    private val _context: Context = UtilKApplicationWrapper.instance.get()
    ...
    fun activeEngine(initListener: com.mozhimen.scank.face.arc.basic.commons.IInitListener?) {
        ...
        when (activeCode) {
            ...
            ErrorInfo.MERR_ASF_ALREADY_ACTIVATED -> {
                ...
                throw Exception(com.mozhimen.scank.face.arc.basic.annors.AInitErrorCode.getMessage(com.mozhimen.scank.face.arc.basic.annors.AInitErrorCode.ERR_ENGINE_ACTIVE_FAIL) + " code:$activeCode")
            }
        }
    }
    ...
    private fun processPreviewData() {
        if (_imageBytes != null) {
            ...
            //刷新人脸框 只显示第一个脸
            Log.v(TAG, "processPreviewData: cloneImageBytes size ${cloneImageBytes.size} facePreviewInfoList $facePreviewInfoList")
